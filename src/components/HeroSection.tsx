...
export default function HeroSection() {
  ...
  // Staggered text reveals — text is hidden on load (only the photo shows),
  // and reveals as soon as you start scrolling. Matches the reference hero.
  ...
  return (
    <div ref={ref} className="relative bg-[#0B0E14]" style={{ height: "250vh" }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        {/* Text — hidden on load, reveals on scroll */}
